...
- **Deploying to the cloud?** Use `authenticated` + `public` — see the [AWS ECS Fargate guide](aws-ecs.md), or the lighter single-VPS [AWS Lightsail (SSH image ship) guide](lightsail-ssh.md)
