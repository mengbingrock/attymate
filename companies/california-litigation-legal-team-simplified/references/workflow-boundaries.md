...
- External uploads, external downloads, Lexis, external knowledge-base/upload systems, browser auth, email, filing, service, signing, finalization, source-file overwrite, source-file rename, source-file deletion, calendar writes, paid retrieval, and material strategy changes require approval.
