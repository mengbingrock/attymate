...
The optional `scripts/ocr_pdf_intake.ps1` helper may be used only when the issue approves local OCR sidecars and supplies exact matter/output paths. It writes under `{output_root}/OCR` and does not modify source PDFs.
