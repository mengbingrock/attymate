...
- Place or link lawyer-facing outputs in the Matter Home when approved; keep issue audit output under `_issues/{issue-identifier}` when filesystem output is used.
