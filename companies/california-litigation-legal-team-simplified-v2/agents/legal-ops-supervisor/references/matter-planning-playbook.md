...
- Reference the parent Matter Safety Contract and include only the objective, relevant sources, output, and exceptions.
...
- Use Calendar Agent for proposed deadlines and pre-deadline reminders. Which calendar actions are gated is stated once in `gating/calendar-monitoring-gates.md`.
