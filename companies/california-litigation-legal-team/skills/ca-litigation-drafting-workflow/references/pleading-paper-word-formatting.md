...
Use this reference only when the issue requests filing-ready formatting, pleading paper, smart TOC/TOA, page numbering, or consistency with an approved sample.
...
Do not file, serve, sign, email, or mark final without separate approval.
