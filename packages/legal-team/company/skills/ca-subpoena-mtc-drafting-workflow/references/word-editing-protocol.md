...
Word work is a red-gate activity unless the task expressly authorizes a new working copy.

Before editing:

- Confirm the exact source draft, output path, and whether the action is a new working copy or approved active-draft update.
- Confirm section text has been reviewed or the task authorizes direct assembly.
