...
Use this reference only when the task requests filing-ready formatting, pleading paper, smart TOC/TOA, page numbering, or consistency with an approved sample.
