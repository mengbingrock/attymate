...
**Receives from:**
- `legal-ops-supervisor` — parent-linked delegated task carrying the Matter Safety Contract (matter root, output root, read-only source roots, forbidden roots, allowed outputs, autonomy level, approval profile, learning mode, and visible hard-gate approvals already granted).
