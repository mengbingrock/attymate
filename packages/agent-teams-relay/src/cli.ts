...
const relay = await startAgentTeamsRelay({ host, port, dataDir, logger: false });
process.stdout.write(
  `${JSON.stringify({ event: 'relay.started', httpUrl: relay.httpUrl, wsUrl: relay.wsUrl, dataDir, insecureLanMode: true })}\n`
);
